# matrix_vector_mul_hlir_example.py -*- Python -*-
...
def matrix_vector_mul_hlir_example_jit(inputA, inputB, outputC):
    M = 256
    K = 256
    m = 32
    k = 32
    ...
    MEM_L2_L1_A1A2A3A4_col0 = inA.cons().split(obj_types=[inA_ty, inA_ty, inA_ty, inA_ty], names=["MEM_L2_L1_A1_col0", "MEM_L2_L1_A2_col0", "MEM_L2_L1_A3_col0", "MEM_L2_L1_A4_col0"], placement=Tile(0, 1))
    B_fwd = inB.cons().forward(placement=Tile(1, 1))
    MEM_L1_L2_C9C10C11C12_col2 = outC.prod().join(obj_types=[outC_ty, outC_ty, outC_ty, outC_ty], names=["MEM_L1_L2_C9_col2", "MEM_L1_L2_C10_col2", "MEM_L1_L2_C11_col2", "MEM_L1_L2_C12_col2"], placement=Tile(2, 1))
...
def main():
    ...
    matrix_vector_mul_hlir_example_jit(inputA, inputB, outputC)
